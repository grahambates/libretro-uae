...
bool prelude_init(struct autoconfig_info *aci) { return false; }
bool prelude1200_init(struct autoconfig_info *aci) { return false; }
bool toccata_init(struct autoconfig_info *aci) { return false; }
bool uaesndboard_init_z2(struct autoconfig_info *aci) { return false; }
bool uaesndboard_init_z3(struct autoconfig_info *aci) { return false; }
